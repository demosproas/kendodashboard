 	...
 	<div   class="demo-section">
			...
			<div   style="position:relative;width:810px;top:0px;left:-20px;margin:0 10px;background-color:none;margin: auto;">
 					<div id="scrollview-content"  style="background-color:none;"  >
							<div id="iso_container" style="width:750px;background-color:none;" >
							
							
									<%
										For count = 1 to 18
											response.write( "<div id='is_" & count & " ' class='item gris'>") & vbCrLf
											response.write( "<div style= 'width:170px'> <center><p class='grid-items'>Indicador " &  count  & "</p> </center></div>") & vbCrLf
											response.write( "<center>") & vbCrLf
											response.write("<img src='segmentos/ca.png' style=' border: 1px solid #727F8E;' > </img>")& vbCrLf
											response.write( "</center>") & vbCrLf
											response.write( "<div   style= 'width:170px; ' >") & vbCrLf
											response.write( "<center>") & vbCrLf
											response.write( "<p id='calind" &  count & "' class='grid-items'>" &  count & "</p> ") & vbCrLf
											response.write( "</center>") & vbCrLf
