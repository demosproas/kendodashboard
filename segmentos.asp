<head>
 	...
 	<div   class="demo-section">
			...
			<script type="text/javascript" charset="utf-8">
								...
								$.ajax({
										url: "benchdata/data_listasegmentos.txt",
								...
								function showInfo(){
								 ...
								 $.each(data['segmentos'], function(index, value) {
											...
											varcontenido = varcontenido + "<div style= 'width:170px'> <center><p class='grid-items'>" +  data['segmentos'][index]['nombre']  + "</p> </center></div>";
											varcontenido = varcontenido + "<center>";
											varcontenido = varcontenido +"<img src='segmentos/" +  data['segmentos'][index]['imagen']  + "' style=' border: 1px solid #727F8E;' > </img>";
											varcontenido = varcontenido + "</center>";
											varcontenido = varcontenido +"<div   style= 'width:170px; ' >";
											varcontenido = varcontenido + "<center>";
											varcontenido = varcontenido + "<p   class='grid-items'>" +  data['segmentos'][index]['valor'] + "</p> ";
											varcontenido = varcontenido + "</center>";
